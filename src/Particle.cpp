...
std::string Particle::toString() const {
  ...
  stream << "Particle: Position:" << position.asArray() << " Velocity: " << velocity.asArray() << " Force: " << force.asArray() << " Old Force: " << old_force.asArray() << " Type: " << type;
  return stream.str();
}

bool Particle::operator==(Particle &other) {
  return (position == other.position) and (velocity == other.velocity) and (force == other.force) and (type == other.type) and (mass == other.mass) and
         (old_force == other.old_force);
}
