...
\begin{frame}{Naive Parallelization}
    ...
    \vspace{0.5cm}
    \begin{tikzpicture}
        \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=1.0\textwidth]{media/compare-naive-parallel.png}};
...
\simpleframe
\begin{frame}{Naive Parallelization}{Algorithmic Improvement}
    TODO: More parallelization slides
\end{frame}

\simpelframe
\begin{frame}{Quick Recap of This Semester}{And Lessons We Learned}
    \begin{itemize}
        \item Halley discovered a comet in our solar system
        \item Refactoring is important! \blue{We had a lot of problems because we underinvested in it in week 1}.
        \item Unit testing is essential.
        \item Continuous Integration is awesome! We learned that you can cache them for CI performance.
        \item Version Control is good, but \blue{communication is still more important}.
        \item Logging is a great debugging practice even in 2026.
        \item Profiling was something new to us and we cannot work without it anymore. % It is simply too useful for measuring performance.
        \item Parallelization needs careful considerations. Naive approaches can degrade performance with overhead.
    \end{itemize}

    \blue{$\Rightarrow$ Software Engineering is important even in scientific computing!}
\end{frame}

\headerframe
\begin{frame}{Thank you!}{Thank you in small!}
    \begin{itemize}
        \item Knock knock.
        \item Who's there?
        \item Thread 1
