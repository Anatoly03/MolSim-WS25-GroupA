...
\simpleframe\begin{frame}[fragile]{Unit tests}
\begin{itemize}
\item Simple assertion
\item Simple particle container test
\item Simple copy detection
\item And more to come$\ldots$
\end{itemize}
...
\begin{figure}
\centering
\includegraphics[width=0.65\textwidth]{media/test_Success.png}
\end{figure}
\end{center}
...
\simpleframe\begin{frame}[fragile]{Collision of two bodies}

\begin{center}
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth]{media/task4_-t_100_-d_0.01.png}
\end{figure}
\caption{We will play a video now.}
\end{center}
