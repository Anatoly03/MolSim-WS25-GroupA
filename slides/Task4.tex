...
\simpleframe\begin{frame}{Profiling Integration}{Tracy}
    \begin{center}
...
\simpleframe\begin{frame}[noframenumbering]{Profiling Integration}{Analysing Zones}
    \begin{center}
        \includegraphics[width=0.6\textwidth]{media/profile-zones.png}
    \end{center}
    ...
    \footnotetext[1]{Commit: cc4ed05a08ea63fc6138b524bb29cfacbb9d7409}
\end{frame}
